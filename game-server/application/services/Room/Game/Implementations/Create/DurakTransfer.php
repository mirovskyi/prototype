 ...
 * Time: 10:05
 *
 * Реализация алгоритма создания игры Durak Transfer
 */
class App_Service_Room_Game_Implementations_Create_DurakTransfer
    extends App_Service_Room_Game_Implementations_Create_Default
{
     ...
     *
     * @return Core_Game_DurakTransfer|Core_Game_Abstract
     */
    public function createGameObject()
    {
        //Создание объекта игры
        $durak = new Core_Game_DurakTransfer();
