 ...
 */
class App_Service_Handler_Durak_Throw extends App_Service_Handler_Abstract
{
    ...
    protected function _handle()
    {
        ...
        //Подбрасываем карты
        $this->getGame()->throwCards($opponentSid, $cards);
     ...
     * ВЫЗЫВАТЬ ДО ИЗМЕНЕНИЯ ДАННЫХ РОЗЫГРЫША (Core_Game_Durak_Process)
     */
