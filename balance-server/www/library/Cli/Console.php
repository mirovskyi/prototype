...
class Cli_Console 
{
    ...
    // Text colors
    public function setStyle($style='default')		{ $this->text .= "\033[".self::$style[$style]."m"; return $this; }
    public function setColor($color='default')		{ $this->text .= "\033[".self::$color[$color]."m"; return $this; }
    public function setBgColor($color='default')	{ $this->text .= "\033[".self::$bgcolor[$color]."m"; return $this; }
