 ...
 */
class App_Service_Server_Payment_Notification_Odnoklassniki implements App_Service_Server_Payment_NotificationInterface
{
    /**
     * Имя социальной сети
     */
    const SNAME = 'odnoklassniki';
    ...
    public function checkRequestSignature(array $params) {
        ...
        if ($sign === $params['sig']) {
            ...
            throw new Zend_Exception('Wrong signature request', 104);
        }
    }
    ...
    public function setRequestParams(array $params)
    {
        ...
        if (isset($params['product_code'])) {
            $this->setPaymentId($params['product_code']);
        }
    ...
    public function success()
    {
        ...
        if (!$payment->find($this->getPaymentId())->getId()) {
            throw new Zend_Exception('Payment id:' . $this->getPaymentId() . ' not find', 1);
        }
