 ...
 * в ORM модели, для таблицы items
 */
class App_Model_Mapper_Item
{
    ...
    public function getDbTable()
    {
        if (!$this->_dbTable instanceof Zend_Db_Table_Abstract) {
            $this->setDbTable('App_Model_DbTable_Item');
        }
     ...
     *
     * @param App_Model_Item $entity Объект сущности
     * @return integer|boolean
     */
    public function save(App_Model_Item $entity)
    {
        $data = array();
     ...
     */
    public function find(App_Model_Item $entity, $id)
    {
     ...
     */
    public function fetchRow(App_Model_Item $entity, $where = null, $order = null)
    {
