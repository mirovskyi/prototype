 ...
 * в ORM модели, для таблицы notifications
 */
class App_Model_Mapper_Notification
{
     ...
     *
     * @param App_Model_Notification $entity Объект сущности
     * @return integer|boolean
     */
    public function save(App_Model_Notification $entity)
    {
        $data = array();
     ...
     */
    public function find(App_Model_Notification $entity, $id)
    {
     ...
     */
    public function fetchRow(App_Model_Notification $entity, $where = null, $order = null)
    {
    ...
    public function fetchAll($where = null, $order = null, $count = null, $offset = null)
    {
        ...
        if ($result->count() > 0) {
            foreach($result as $row) {
                $entity = new App_Model_Notification();
                $entity->setId($row->id);
                $entity->setIdUser($row->id_user);
                $entity->setName($row->name);
                $entity->setParams($row->params);
